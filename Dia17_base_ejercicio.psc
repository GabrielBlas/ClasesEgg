...
SubProceso calcularContraPisos()
	...
	base = espesor * ancho * largo
	Escribir "De cemento se necesita: ", 105 * base
	Escribir "De arena se necesita: ", 0.45 * base
	Escribir "De piedra se necesita: ", 0.9 * base
FinSubProceso
...
subproceso calcularIluminacion()
	definir alto, largo, superficie, cantMinima como entero
